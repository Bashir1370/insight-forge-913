...
export const bulkRnaSeqLessons: SpecialistLesson[] = [
  ...
  },
  {
    ...
    summary:
      "معنای سطر، ستون و خانه‌های ماتریس، مسیرهای ساخت شمارش و اتصال آن به فراداده را قدم‌به‌قدم یاد بگیرید.",
    principle:
      "ماتریس شمارش قرارداد مشترک بین کمی‌سازی، هویت نمونه و تحلیل آماری است.",
    status: "active",
