...
export type OmicsDomain = "genomics";
export type ResourceType = "data-portal";
...
export const dataResources = [
  {
    id: "gdc-tcga",
    slug: "gdc",
    title: "Genomic Data Commons / TCGA",
    shortTitle: "GDC / TCGA",
    organization: "NCI",
    description: "یادگیری مسیر کار با Genomic Data Commons و داده‌های TCGA.",
    domains: ["genomics"],
    resourceType: "data-portal",
    modalities: ["Cancer Genomics"],
    topics: ["TCGA", "GDC"],
    status: "active",
  },
];
    ...
    <section dir="rtl" className="min-h-screen bg-slate-950 p-8 text-white">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mt-8 rounded-3xl border border-slate-700 bg-slate-900 p-6">
          ...
          <p className="mt-3 text-slate-300">آموزش تعاملی پورتال GDC و داده‌های TCGA.</p>
          <Link to="/resources/gdc" className="mt-6 inline-block rounded-xl bg-teal-600 px-5 py-3 font-bold">
